...
Le but est d'évaluer la **couverture réelle** d'OpenStreetMap sur les structures de stage du 44/85. L'absence de résultat n'est pas une erreur : de nombreux établissements n'ont pas de téléphone, courriel, site web ou SIRET renseigné dans OSM.

La fonctionnalité est intégrée à `main` en conservant explicitement le statut **Expérimental** tant que sa pertinence n'a pas été vérifiée sur des structures réelles.
